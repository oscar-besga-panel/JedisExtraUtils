...
public class FunctionalInterruptedWritingFileTest {
    ...
    private static final String COMMON_REDIS_TEST_NAME = "lock:" + FunctionalInterruptedWritingFileTest.class.getName() + ":";
    ...
    private class WriteTest implements Runnable {
        ...
        public void run() {
            try {
                jedisLock = new InterruptingJedisJedisLockBase(redisClient, lockName, milis, TimeUnit.MILLISECONDS);
