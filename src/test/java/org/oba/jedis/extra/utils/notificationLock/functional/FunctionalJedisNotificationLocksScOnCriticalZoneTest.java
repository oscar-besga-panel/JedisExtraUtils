...
public class FunctionalJedisNotificationLocksScOnCriticalZoneTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(FunctionalJedisNotificationLocksScOnCriticalZoneTest.class);

    private static final String COMMON_REDIS_TEST_NAME = "flock:" + FunctionalJedisNotificationLocksScOnCriticalZoneTest.class.getName() + ":";
