...
import org.oba.jedis.extra.utils.semaphore.JedisSemaphore2;
...
public class FunctionalSemaphoreWaitingTest2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(FunctionalSemaphoreWaitingTest2.class);
