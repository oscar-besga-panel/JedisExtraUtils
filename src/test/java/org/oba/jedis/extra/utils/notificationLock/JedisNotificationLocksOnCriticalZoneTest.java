...
public class JedisNotificationLocksOnCriticalZoneTest {


    private static final Logger LOGGER = LoggerFactory.getLogger(JedisNotificationLocksOnCriticalZoneTest.class);
...
//            t3.start();
    ...
    private void accesLockOfCriticalZone(int sleepTime) {
        try {
            NotificationLock jedisLock = new NotificationLock(mockOfJedis.getJedisPool(), lockName);
