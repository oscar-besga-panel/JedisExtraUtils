...
public class ScriptHolderTest {
    ...
    public void before() throws IOException {
        ...
        scriptHolder = new ScriptHolder(mockOfJedis.getRedisClient());
    }
    ...
    public void generateHolderForJedisExtraUtilsTest() {
        ScriptHolder holder = ScriptHolder.generateHolderForJedisExtraUtils(mockOfJedis.getRedisClient());
    ...
    @Test
    public void addTest() {
        ScriptEvalSha1 scriptEvalSha1 = new ScriptEvalSha1(mockOfJedis.getRedisClient(),
