...
public class FunctionalLocksWithNotificationsOnCriticalZoneTest {


    private static final Logger LOGGER = LoggerFactory.getLogger(FunctionalLocksWithNotificationsOnCriticalZoneTest.class);
    ...
    private void accesLockOfCriticalZone(int sleepTime) {
        try {
            Lock lock = new JedisLockWithNotification(jedisPool, lockName).asConcurrentLock();
            lockList.add(lock);
            lock.lock();
            checkLock(lock);
