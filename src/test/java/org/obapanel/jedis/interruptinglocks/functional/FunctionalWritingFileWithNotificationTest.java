...
public class FunctionalWritingFileWithNotificationTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(FunctionalWritingFileWithNotificationTest.class);
    ...
    private class WriteTest implements Runnable {
        ...
        public void run() {
            ...
            try {
                jedisLock = new JedisLockWithNotification(jedisPool, lockName, milis, TimeUnit.MILLISECONDS);
