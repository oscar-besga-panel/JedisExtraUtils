...
public class MockOfJedis {
    ...
    private Object mockGet(String key) {
        return data.get(key);
    }

    private Object mockEval(String script, List<String> keys, List<String> values) {
    ...
    private String mockSet(final String key, String value, SetParams setParams) {
