 ...
 */
public class MockOfJedisForRedisCache {

    private static final Logger LOG = LoggerFactory.getLogger(MockOfJedisForRedisCache.class);
    ...
    static boolean unitTestEnabledForRedisCache(){
    ...
    private final List<TransactionOrder<? extends Object>> transactionActions = new ArrayList<>();
    private final Timer timer;


    public MockOfJedisForRedisCache() {
        timer = new Timer();
