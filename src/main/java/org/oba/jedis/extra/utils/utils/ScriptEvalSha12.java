 ...
 *
 */
public class ScriptEvalSha12 {

    private static final Logger LOGGER = LoggerFactory.getLogger(ScriptEvalSha12.class);
    ...
    public ScriptEvalSha12(JedisPooled jedisPooled, UniversalReader scriptSource) {
        this(jedisPooled, scriptSource, false);
    }

    public ScriptEvalSha12(JedisPooled jedisPooled, UniversalReader scriptSource, boolean autoload) {
